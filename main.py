...
@app.route('/')
def home():
    return "Bot @BERACUY_BOT aktif 24 jam!"
...
# === KONFIGURASI BOT ===
TOKEN = "8185914981:AAHEepdiEmrN8A4Tgc0rRVjOn6t50rnKX3E"
ADMIN_IDS = [7755401822, 6925289822, 1890985441, 5397964203]
MAKS_IZIN = 5
...
def main():
    ...
    # ⏱️ Cek auto kembali tiap 1 menit
    job_queue = app_bot.job_queue
    job_queue.run_repeating(auto_kembali, interval=60, first=10)

    print("✅ BOT AKTIF: @BERACUY_BOT dengan fitur auto-in + denda per menit")
    keep_alive()
    app_bot.run_polling()
